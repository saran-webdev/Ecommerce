...
import Main_navbar from "../common_pages/main_navbar";
import Button from "react-bootstrap/Button";
import Card from "react-bootstrap/Card";
import Flickity from "flickity";
import "flickity/css/flickity.css";
import "../common_css/home.css";
import Main_footer from "../common_pages/main_footer";
...
const Home = () => {
  ...
  return (
    <div>
      ...
      <Container>
        <Row className=" mt-3">
          <img src="/home/banner.webp" className="img-fluid" alt="" />
        </Row>
        <Row>
        ...
        <Row>
          <div className="text-center mt-3">
            ...
            <h1 className=" fs-3">POPULAR T-SHIRTS</h1>
          </div>
        </Row>
        <Row className="mt-3">
        ...
        <Row className=" text-center">
          ...
          <p>
            <b>
              Thickness is perfect, Quality is good. L size is loose as compare
              to other brands. Color is fine.
            </b>
          </p>
          <p>~ REMO</p>
        </Row>
